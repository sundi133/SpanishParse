...
public class CodeSheet {
	...
	public static void main(String[] args) {
		...
		final String beginHeader = "([0-9]+)\\.{1} .*";
		pattern = Pattern.compile(beginHeader);
		HashMap<String,HashMap<Integer, String>> mapkeyVal = new HashMap<String,HashMap<Integer, String>>();



		try {
			//FileInputStream fstream1 = new FileInputStream(filesInDir[i]);
			FileInputStream fstream1 = new FileInputStream("C:\\Users\\sundi133\\Downloads\\CodebookCodes.doc");
			...
			Iterator entries= mapkeyVal.keySet().iterator();
			...
			while (entries.hasNext()) {
				...
				HashMap map = (HashMap) mapkeyVal.get(keys);
		    ...
		    String translatedText = Translate.execute(" 4 horas. Comenzaron a llegar desde las 10 de la mañana, Duhalde apareció a las 13 y desconcentración luego de las 2", Language.SPANISH, Language.ENGLISH);
